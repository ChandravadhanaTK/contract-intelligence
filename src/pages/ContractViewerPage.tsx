...
const extractedClauses: ExtractedClause[] = [
  ...
  { id: "ec-11", name: "Rate Schedule Extraction", sectionId: "rate-schedule", sectionRef: "Exhibit A", pageRef: "Page 45", category: "Financial", confidence: "High", alignment: "aligned", summary: "Healthcare provider contract rate schedule — Contract Terms, Admin Fees, AWP-based Pricing, Client Rebate Share — 23 line items extracted", complianceScore: 88 },
